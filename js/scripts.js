...
mr = (function (mr, $, window, document) {
  ...
  mr.deadline = mr.deadline || {};

  mr.deadline.documentReady = function ($) {
    ...
    const time = new Date().addHours(4).getTime();       
  ...
  mr.components.documentReady.push(mr.deadline.documentReady);
